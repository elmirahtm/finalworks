...
<div className='flex justify-center max-sm:block max-sm:bg-white max-sm:h-[110rem] '>
<div className='bg-white w-[70rem] mb-20 shadow-xl py-10 '>
<div className='px-32'>
<div>
    <h1 className='font-bold text-2xl ml-20'>Servis Mərkəzi</h1>
    <h5 className='font-bold mx-16 my-8 max-sm:w-[26rem]'>Bu gün bizim Call Center bir neçə funksiya həyata keçirir:</h5>
  </div>
  <ul className='ml-16'>
  ...
  <div>
    <h3 className='text-3xl w-[50rem] ml-14 max-sm:w-[26rem]'>Call Center-də bu mövzular haqqında ətraflı məlumat əldə etmək mümkündür.</h3>
  </div>
  <ul className='ml-16'>
