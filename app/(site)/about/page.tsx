              ...
              <div className="bg-white w-[70rem] mb-20 shadow-xl py-10 ">
                <div className="px-32">
                  <div>
                    ...
                    <h5 className="font-bold mx-16 my-8 max-sm:w-[26rem]">
                  ...
                  <div>
                    <h3 className="text-3xl w-[50rem] ml-14 max-sm:w-[26rem]">
                  ...
                  <div>
                    <p className="ml-16 w-[40rem] max-sm:w-[26rem] ">
                    ...
                    <p className="mt-10 ml-16 w-[35rem] max-sm:w-[26rem]">
