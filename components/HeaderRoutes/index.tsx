    ...
    <nav >
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters >
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' ,alignItems:"end",justifyContent:"end"} }}>
            <IconButton
              size="large"
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' ,alignItems:"center",justifyContent:"space-evenly" } }}>
            {basliq.map(({id,title,to}) => (
             <Link href={to}>
              <Button
                key={id}
