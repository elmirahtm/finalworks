            ...
            return (
              <div key={id} className="">
                <div className='max-sm:ml-14'>
                  ...
                  <div>
                    <div className='bg-teal-950  text-warning-50 w-56 p-3   max-sm:bg-transparent max-sm:text-transparent  max-lg:bg-transparent max-lg:text-transparent  max-xl:bg-transparent max-xl:text-transparent'>{basliq}</div>
                  </div>
                </div>
              </div>
            )
