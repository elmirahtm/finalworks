...
const LiderService = () => {
  return (
    <div>
      <div
        className='bg-[url("/bg2.png")] w-full h-[45rem] flex justify-center items-start max-sm:h-[65rem]  max-lg:h-[65rem]
        p-20 '
      >
        <div className="container m-auto">
          <div className="flex justify-center items-center max-sm:flex-wrap max-sm:text-center max-sm:text-sm  max-lg:flex-wrap max-lg:text-center max-lg:text-sm ">
            <div>
              <span>
                <Image
                  className="max-sm:w-80 max-sm:h-80 max-lg:w-80 max-lg:h-80 max-sm:m-auto max-lg:ml-12"
              ...
              <span>
                <div className="flex max-sm:mt-8 ">
                  ...
                  <div className="mt-3 mb-2">
                    <h4 className="text-xl font-bold max-sm:m-auto max-lg:ml-10  ">
                      Ehtiyyat hissələri və aksesuarlar{" "}
                    </h4>
                    <p className="w-[22rem] max-sm:w-96 max-sm:text-justify max-lg:text-justify max-sm:ml-8 max-lg:ml-10">
                ...
                <div className="flex max-sm:mt-8 ">
                  ...
                  <div className="">
                    <h4 className="text-xl font-bold max-sm:m-auto max-lg:m-auto max-sm:-ml-11 ">
                      Zəmanət qüvvəsi
                    </h4>
                    <p className="w-[30rem] max-sm:w-[22rem] max-sm:text-justify max-lg:w-[22rem] max-lg:text-justify max-sm:ml-8 max-lg:ml-10">
