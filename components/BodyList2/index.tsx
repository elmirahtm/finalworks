    ...
    <div>
      <div>
        <div className="mt-14">
          ...
          <div>
            <span className="flex  justify-center gap-10 mt-10">
        ...
        {/*  */}
        {/*  */}
        <div className='bg-[url("/bg.png")] w-full h-[60rem] mb-10'>
          <div>
            <div>
              <div className="">
                {/* <p className=" bg-red-600  w-16 h-2  "></p> */}
                <h5 className="p-2 mb-10 relative -ml-8 text-center text-2xl font-bold ">
                  Təmir
                </h5>
        ...
        <div className="flex justify-center m-16  gap-28  max-sm:mb-14 max-sm:p-5">
          <span>
            <Image
