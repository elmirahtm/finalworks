...
const Header = () => {
 ...
 <div className='w-6'><Image src="/Line.png" alt='line' width={1} height={0.5}/></div>
...
<span className='relative -top-9 left-5'>    <Image src="/call.png" alt='daire' width={31} height={29}/>
</span>    
<span className='relative -top-16 left-12 '>    <Image src="/180.png" alt='180' width={51 } height={28}/>
</span>   </div> 
  </span>
</div>
